package com.samridhi.musicPlanet;
...
import com.samridhi.musicPlanet.adapters.AlbumsAdapter;
import com.samridhi.musicPlanet.adapters.ArtistsAdapter;
import com.samridhi.musicPlanet.adapters.ColorsAdapter;
import com.samridhi.musicPlanet.adapters.SongsAdapter;
import com.samridhi.musicPlanet.loaders.ArtistProvider;
...
import com.samridhi.musicPlanet.playback.EqualizerUtils;
import com.samridhi.musicPlanet.playback.MusicNotificationManager;
import com.samridhi.musicPlanet.playback.MusicService;
import com.samridhi.musicPlanet.playback.PlaybackInfoListener;
import com.samridhi.musicPlanet.playback.PlayerAdapter;

import com.samridhi.musicPlanet.slidinguppanel.SlidingUpPanelLayout;
...
public class MainActivity extends FragmentActivity implements LoaderManager.LoaderCallbacks<List<Artist>>, SongsAdapter.SongSelectedListener, ColorsAdapter.AccentChangedListener, AlbumsAdapter.AlbumSelectedListener, ArtistsAdapter.ArtistSelectedListener {
    ...
    public void openGitPage(View v) {
        try {
            startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("https://github.com/samridhikots")));
