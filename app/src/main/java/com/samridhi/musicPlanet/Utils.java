...
public class Utils {
    ...
    private static final String ACCENT_PREF = "com.samridhi.musicPlanet.pref_accent";
    private static final String ACCENT_VALUE = "com.samridhi.musicPlanet.pref_accent_value";
    private static final String THEME_PREF = "com.samridhi.musicPlanet.pref_theme";
    private static final String THEME_VALUE = "com.samridhi.musicPlanet.pref_theme_value";
